...
|---|---|---|
| `0*7*` | `0179` | ✓ (pos 0=0, pos 2=7) |
| `0*7*` | `9207` | ✗ (pos 0 mismatch) |
| `9*0*` | `9207` | ✓ (pos 0=9, pos 2=0) |
...
검증 (사용자 설정: `15776000,현대` / `18001111,하나,9207` / `18001111,하나,0179`):
- `15776000,현대` → 0건 (15776000의 RCS는 SMS변경 안내 1건뿐, 금액 라벨 없어 skip).
- `18001111,하나,9207` → SMS `9*0*` 마스킹 1건만 매치 (-18,000원).
- `18001111,하나,0179` → SMS `0*7*` 3건 + RCS `0*7*` 1건 매치 (+60,000, -13,900×2, +959,100).
