...
- 파싱 룰을 새로 만들 때 사용한 알림은 **그대로(전체 raw 객체) `MyCard/docs/data/<카드사>.jsonl`에 한 줄씩 저장**한다. 같은 카드사의 다른 카드(예: 신한 9999/9999) 도 하나의 파일에 누적 append.
